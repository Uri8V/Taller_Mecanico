    ...
    public partial class frmTipoDePago : Form
    {
        ...
        private void toolStripButtonBorrar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DialogResult dr = MessageBox.Show($"¿Desea eliminar el Tipo de Pago: {tipo.TipoPago}?", "Confirmar Eliminación", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2);
